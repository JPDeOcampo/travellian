                    ...
                    {tripPlanners.map((item, index) => {
                        return (
                            <div className="group relative">
                                <div className={`h-[400px] w-full rounded-3xl overflow-hidden relative shadow-cardShadow-1 z-[4] ${index % 2 === 0 ? "-translate-y-28" : "-translate-y-28 group-hover:lg:-translate-y-28 lg:translate-y-0"} transition-all`} key={index}>
